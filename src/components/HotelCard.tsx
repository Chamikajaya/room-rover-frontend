...
export default function HotelCard({hotel}: HotelCardProps) {
    return (
        <div
            className="mt-8 p-6 border border-primary rounded-lg shadow-lg bg-white dark:bg-gray-800 dark:border-gray-700 grid grid-cols-1 lg:grid-cols-[2fr_3fr] gap-8 transition-transform transform hover:scale-105">
